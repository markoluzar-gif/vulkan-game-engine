...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowBgAlpha(float alpha);                                          // set next window background color alpha. helper to easily override the Alpha component of ImGuiColwindow_managerBg/ChildBg/PopupBg. you may also use ImGuiWindowFlags_NoBackground.
    ...
    IMGUI_API void          SetTabItemClosed(const char* tab_or_dockedwindow_manager_label);           // notify TabBar or Docking system of a closed tab/window ahead (useful to reduce visual flicker on reorderable tab bars). For tab-bar: call after BeginTabBar() and before Tab submissions. Otherwise call with a window name.
...
enum ImGuiCol_
{
    ...
    ImGuiColwindow_managerBg,              // Background of normal windows
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVarwindow_managerPadding,            // ImVec2    WindowPadding
    ImGuiStyleVarwindow_managerRounding,           // float     WindowRounding
    ImGuiStyleVarwindow_managerBorderSize,         // float     WindowBorderSize
    ImGuiStyleVarwindow_managerMinSize,            // ImVec2    WindowMinSize
    ImGuiStyleVarwindow_managerTitleAlign,         // ImVec2    WindowTitleAlign
...
struct ImGuiViewport
{
    ...
    void*               PlatformHandle;         // void* to hold higher-level, platform window handle (e.g. HWND, GLFWWindow*, SDLwindow_manager*)
...
// RENAMED IMGUI_DISABLE_METRICSwindow_manager > IMGUI_DISABLE_DEBUG_TOOLS in 1.88 (from June 2022)
#ifdef IMGUI_DISABLE_METRICSwindow_manager
#error IMGUI_DISABLE_METRICSwindow_manager was renamed to IMGUI_DISABLE_DEBUG_TOOLS, please use new name.
#endif
