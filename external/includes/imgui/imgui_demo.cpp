...
// linked, you can setup your imconfig.h with #define IMGUI_DISABLE_DEMOwindow_managerS and those functions will be empty.
...
#if !defined(IMGUI_DISABLE_DEMOwindow_managerS)
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    {
        static bool embed_all_inside_a_childwindow_manager = false;
        ImGui::Checkbox("Embed everything inside a child window for testing _RootWindow flag.", &embed_all_inside_a_childwindow_manager);
        if (embed_all_inside_a_childwindow_manager)
        ...
        static bool testwindow_manager = false;
        ImGui::Checkbox("Hovered/Active tests after Begin() for title bar testing", &testwindow_manager);
        if (testwindow_manager)
        {
            ImGui::Begin("Title bar Hovered/Active tests", &testwindow_manager);
            if (ImGui::BeginPopupContextItem()) // <-- This is using IsItemHovered()
            {
                if (ImGui::MenuItem("Close")) { testwindow_manager = false; }
                ImGui::EndPopup();
            }
            ImGui::Text(
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        static bool show_horizontal_contents_size_demowindow_manager = false;
        ImGui::Checkbox("Show Horizontal contents size demo window", &show_horizontal_contents_size_demowindow_manager);

        if (show_horizontal_contents_size_demowindow_manager)
        {
            ...
            ImGui::Begin("Horizontal contents size demo window", &show_horizontal_contents_size_demowindow_manager, show_h_scrollbar ? ImGuiWindowFlags_HorizontalScrollbar : 0);
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    // Submit window
    if (!window_padding)
        ImGui::PushStyleVar(ImGuiStyleVarwindow_managerPadding, ImVec2(0.0f, 0.0f));
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            //      ImGui::PushStyleVar(ImGuiStyleVarwindow_managerPadding, ImVec2(0, 0));      // Disable padding
