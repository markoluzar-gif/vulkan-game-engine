...
enum ImGuiLocKey : int
{
    ...
    ImGuiLocKeywindow_manageringMainMenuBar,
    ImGuiLocKeywindow_manageringPopup,
    ImGuiLocKeywindow_manageringUntitled,
...
namespace ImGui
{
    ...
    IMGUI_API void          UpdateWindowParentAndRootLinks(ImGuiWindow* window, ImGuiWindowFlags flags, ImGuiWindow* parentwindow_manager);
    ...
    inline void             SetWindowParentWindowForFocusRoute(ImGuiWindow* window, ImGuiWindow* parentwindow_manager) { window->ParentWindowForFocusRoute = parentwindow_manager; }
    ...
    IMGUI_API void          FocusTopMostWindowUnderOne(ImGuiWindow* under_thiswindow_manager, ImGuiWindow* ignorewindow_manager, ImGuiViewport* filter_viewport, ImGuiFocusRequestFlags flags);
    IMGUI_API void          BringWindowToFocusFront(ImGuiWindow* window);
    IMGUI_API void          BringWindowToDisplayFront(ImGuiWindow* window);
    IMGUI_API void          BringWindowToDisplayBack(ImGuiWindow* window);
    IMGUI_API void          BringWindowToDisplayBehind(ImGuiWindow* window, ImGuiWindow* abovewindow_manager);
    ...
    IMGUI_API void          FindHoveredWindowEx(const ImVec2& pos, bool find_first_and_in_any_viewport, ImGuiWindow** out_hoveredwindow_manager, ImGuiWindow** out_hoveredwindow_manager_under_movingwindow_manager);
...
//#endif
    ...
    // Popups, Modals
    IMGUI_API bool          BeginPopupEx(ImGuiID id, ImGuiWindowFlags extrawindow_manager_flags);
    IMGUI_API void          OpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags = ImGuiPopupFlags_None);
    IMGUI_API void          ClosePopupToLevel(int remaining, bool restore_focus_towindow_manager_under_popup);
    IMGUI_API void          ClosePopupsOverWindow(ImGuiWindow* refwindow_manager, bool restore_focus_towindow_manager_under_popup);
    ...
    // Tooltips
    IMGUI_API bool          BeginTooltipEx(ImGuiTooltipFlags tooltip_flags, ImGuiWindowFlags extrawindow_manager_flags);
    ...
    IMGUI_API bool          TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* dockedwindow_manager);
