...
struct ImGui_ImplVulkanwindow_managerRenderBuffers;
...
void ImGui_ImplVulkan_DestroyWindowRenderBuffers(VkDevice device, ImGui_ImplVulkanwindow_managerRenderBuffers* buffers, const VkAllocationCallbacks* allocator);
void ImGui_ImplVulkanH_DestroyFrame(VkDevice device, ImGui_ImplVulkanH_Frame* fd, const VkAllocationCallbacks* allocator);
void ImGui_ImplVulkanH_DestroyFrameSemaphores(VkDevice device, ImGui_ImplVulkanH_FrameSemaphores* fsd, const VkAllocationCallbacks* allocator);
void ImGui_ImplVulkanH_CreateWindowSwapChain(VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanHwindow_manager* wd, const VkAllocationCallbacks* allocator, int w, int h, uint32_t min_image_count);
void ImGui_ImplVulkanH_CreateWindowCommandBuffers(VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanHwindow_manager* wd, uint32_t queue_family, const VkAllocationCallbacks* allocator);
...
// Each viewport will hold 1 ImGui_ImplVulkanHwindow_managerRenderBuffers
// [Please zero-clear before use!]
struct ImGui_ImplVulkanwindow_managerRenderBuffers
{
    uint32_t            Index;
...
struct ImGui_ImplVulkan_Data
{
    ...
    ImGui_ImplVulkanwindow_managerRenderBuffers MainWindowRenderBuffers;
...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline)
{
    ...
    ImGui_ImplVulkanwindow_managerRenderBuffers* wrb = &bd->MainWindowRenderBuffers;
...
void ImGui_ImplVulkanH_CreateOrResizeWindow(VkInstance instance, VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanHwindow_manager* wd, uint32_t queue_family, const VkAllocationCallbacks* allocator, int width, int height, uint32_t min_image_count)
{
    IM_ASSERT(g_FunctionsLoaded && "Need to call ImGui_ImplVulkan_LoadFunctions() if IMGUI_IMPL_VULKAN_NO_PROTOTYPES or VK_NO_PROTOTYPES are set!");
    (void)instance;
...
void ImGui_ImplVulkanH_DestroyWindow(VkInstance instance, VkDevice device, ImGui_ImplVulkanHwindow_manager* wd, const VkAllocationCallbacks* allocator)
{
    ...
    *wd = ImGui_ImplVulkanHwindow_manager();
}
